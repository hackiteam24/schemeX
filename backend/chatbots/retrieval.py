...
STATE_NAME_ALIASES = {
    ...
    "maharashtra": ["maharashtra"],
    "gujarat": ["gujarat"],
    "west_bengal": ["west bengal", "bengal"],
    ...
    "himachal_pradesh": ["himachal pradesh", "himachal"],
    "dadra_nagar_haveli": ["dadra and nagar haveli", "dadra nagar haveli", "daman and diu"],
    "assam": ["assam"],
    "lakshadweep": ["lakshadweep"],
    "chhattisgarh": ["chhattisgarh", "chattisgarh"],
    "tripura": ["tripura"],
    "jammu_kashmir": ["jammu and kashmir", "jammu kashmir"],
    "ladakh": ["ladakh"],
    "punjab": ["punjab"],
    "sikkim": ["sikkim"],
    ...
    "manipur": ["manipur"],
    "mizoram": ["mizoram"],
    "andaman_nicobar": ["andaman and nicobar", "andaman nicobar", "andaman"],
    "nagaland": ["nagaland"],
}
